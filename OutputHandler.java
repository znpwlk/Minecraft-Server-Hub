        ...
        if (eulaFile.exists()) {
            javax.swing.SwingUtilities.invokeLater(() -> {
                ...
                if (option == JOptionPane.YES_OPTION) {
                    try {
                        BufferedReader reader = new BufferedReader(new InputStreamReader(new java.io.FileInputStream(eulaFile), java.nio.charset.StandardCharsets.UTF_8));
                        ...
                        BufferedWriter writer = new BufferedWriter(new java.io.OutputStreamWriter(new java.io.FileOutputStream(eulaFile), java.nio.charset.StandardCharsets.UTF_8));
